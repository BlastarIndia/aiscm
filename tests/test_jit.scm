...
(ok (equal? '(#x39 #xfe) (CMP ESI EDI))
    "CMP ESI EDI")
(ok (eqv? 1 ((asm ctx int8 (list (CMP ESI EDI) (SETE AL) (RET)) int int) i1 i1))
    "Compare integer with itself")
(ok (eqv? 0 ((asm ctx int8 (list (CMP ESI EDI) (SETE AL) (RET)) int int) i1 (logxor 1 i1)))
